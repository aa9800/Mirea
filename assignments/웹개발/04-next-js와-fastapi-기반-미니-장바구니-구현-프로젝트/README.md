# Next.js와 FastAPI 기반 미니 장바구니 구현 프로젝트

- 과목: 웹개발
- 날짜: 2026-08-18
- 태그: nextjs, fastapi, sqlite, react, typescript, 장바구니

## 설명

Next.js 프론트엔드와 FastAPI, SQLite 백엔드를 연동하여 개발한 미니 쇼핑몰 장바구니 프로젝트입니다. 프론트엔드에서는 React와 TypeScript를 사용하여 상품 목록 조회, 장바구니 추가, 수량 변경 및 삭제 등의 동적 웹 UI를 구현했습니다. 백엔드 API 서버는 RESTful 엔드포인트를 제공하며 SQLite 데이터베이스와 연동하여 상품 정보 및 장바구니 상태를 영속적으로 관리합니다. 중복 상품 추가 시 수량 누적, 수량 동적 변경, 장바구니 비우기 등의 비즈니스 로직이 처리되어 있습니다. 전반적인 풀스택 웹 애플리케이션 개발 흐름과 프론트-백엔드 간 API 통신 구조를 학습할 수 있습니다.

## 코드

<details>
<summary><strong>미니장바구니 실습/frontend/eslint.config.mjs</strong> — Next.js 및 TypeScript 프로젝트의 코드 스타일과 무시할 파일 경로를 정의하는 ESLint 설정 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/next-env.d.ts</strong> — Next.js의 TypeScript 지원을 위해 자동 생성된 환경 타입 선언 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/next.config.ts</strong> — Next.js 프레임워크 전반의 빌드 옵션 및 환경 구성을 설정하는 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/package.json</strong> — 프론트엔드 앱의 프로젝트 메타데이터, 스크립트 명령어, 패키지 의존성(Next.js, React, Tailwind CSS 등)을 관리하는 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/postcss.config.mjs</strong> — Tailwind CSS 컴파일을 위한 PostCSS 플러그인 설정 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/tsconfig.json</strong> — TypeScript 컴파일 옵션, 모듈 해석 규칙 및 경로 별칭 설정이 담긴 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/app/globals.css</strong> — Tailwind CSS 모듈을 불러오고 기본 라이트/다크 테마 및 스타일 변수를 설정한 CSS 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/app/layout.tsx</strong> — 애플리케이션 최상위 레이아웃 구성 요소로 폰트 및 글로벌 HTML 구조를 정의하는 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/app/page.tsx</strong> — 상품 목록 및 장바구니 조작(추가, 수량 변경, 삭제)을 위한 백엔드 API 연동과 메인 UI를 담고 있는 컴포넌트 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/app-path-routes-manifest.json</strong> — Next.js App Router 경로와 파일 간의 매핑을 기록한 빌드 생성 결과 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/build-manifest.json</strong> — 빌드 단계에서 생성된 청크 파일 및 리소스 스크립트 매핑 정보를 가지고 있는 파일입니다.</summary>
...
```json
{
  ...
  "lowPriorityFiles": [
    "static/i4PQf1wtzm-edUKqk3aot/_buildManifest.js",
    "static/i4PQf1wtzm-edUKqk3aot/_ssgManifest.js",
    "static/i4PQf1wtzm-edUKqk3aot/_clientMiddlewareManifest.js"
  ],
  "rootMainFiles": [
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/export-marker.json</strong> — Next.js 내보내기(Export) 메타데이터 설정 정보를 포함하는 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/fallback-build-manifest.json</strong> — 대체(Fallback) 렌더링에 필요한 빌드 매니페스트 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/images-manifest.json</strong> — Next.js Image 컴포넌트의 허용 규격, 로더 및 이미지 최적화 설정을 담은 메니페스트입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/prerender-manifest.json</strong> — 정적 생성(SSG) 및 사전 렌더링 라우트 정보를 담고 있는 빌드 메타데이터입니다.</summary>
...
```json
{
  ...
  "notFoundRoutes": [],
  "preview": {
    "previewModeId": "3a3d355835ec8bbd6512d4911ce7f3e3",
    "previewModeSigningKey": "271c0d613f952fc385e56965ba66816b1e617b235cfa559fc13a6e8eb489fb6c",
    "previewModeEncryptionKey": "e66710a2efd88368f8d061831d7ce2f004112ec3bd26f5593e7ad3ca66d8843b"
  }
}
```
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/required-server-files.js</strong> — Next.js 서버 실행에 필요한 설정 객체를 저장한 스크립트 파일입니다.</summary>
...
self.__SERVER_FILES_MANIFEST={
  ...
  "config": {
    ...
    "outputFileTracingRoot": "C:\\Users\\a9800\\OneDrive\\바탕 화면\\공부\\피지컬ai\\미니장바구니 실습\\frontend",
    ...
    "repoRoot": "C:\\Users\\a9800\\OneDrive\\바탕 화면\\공부\\피지컬ai\\미니장바구니 실습\\frontend",
    "turbopack": {
      "root": "C:\\Users\\a9800\\OneDrive\\바탕 화면\\공부\\피지컬ai\\미니장바구니 실습\\frontend"
    },
    "distDirRoot": ".next"
  },
  "appDir": "C:\\Users\\a9800\\OneDrive\\바탕 화면\\공부\\피지컬ai\\미니장바구니 실습\\frontend",
  "relativeAppDir": "",
  "files": [
    ".next\\package.json",
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/required-server-files.json</strong> — Next.js 서버 동작 필수 환경 구성 값을 담은 JSON 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/routes-manifest.json</strong> — 애플리케이션의 라우팅 구조, 리다이렉트 및 헤더 관련 빌드 설정이 기재된 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/_events_14216.json</strong> — Next.js CLI 서버 실행 중 기록된 세션 이벤트 로그 파일입니다.</summary>

```json
[{"eventName":"NEXT_CLI_SESSION_STOPPED","payload":{"nextVersion":"16.3.1","nodeVersion":"v24.19.0","cliCommand":"dev","durationMilliseconds":1717,"turboFlag":true,"pagesDir":false,"appDir":true,"isRspack":false}}]
```

</details>

<details>
<summary><strong>미니장바구니 실습/frontend/.next/_events_19936.json</strong> — Next.js CLI 서버 실행 중 기록된 세션 이벤트 로그 파일입니다.</summary>

```json
[{"eventName":"NEXT_CLI_SESSION_STOPPED","payload":{"nextVersion":"16.3.1","nodeVersion":"v24.19.0","cliCommand":"dev","durationMilliseconds":1714,"turboFlag":true,"pagesDir":false,"appDir":true,"isRspack":false}}]
```

</details>

<details>
<summary><strong>미니장바구니 실습/frontend/.next/_events_22000.json</strong> — Next.js CLI 서버 실행 중 기록된 세션 이벤트 로그 파일입니다.</summary>

```json
[{"eventName":"NEXT_CLI_SESSION_STOPPED","payload":{"nextVersion":"16.3.1","nodeVersion":"v24.19.0","cliCommand":"dev","durationMilliseconds":1625,"turboFlag":true,"pagesDir":false,"appDir":true,"isRspack":false}}]
```

</details>

<details>
<summary><strong>미니장바구니 실습/frontend/.next/_events_25732.json</strong> — Next.js CLI 서버 실행 중 기록된 세션 이벤트 로그 파일입니다.</summary>

```json
[{"eventName":"NEXT_CLI_SESSION_STOPPED","payload":{"nextVersion":"16.3.1","nodeVersion":"v24.19.0","cliCommand":"dev","durationMilliseconds":1719,"turboFlag":true,"pagesDir":false,"appDir":true,"isRspack":false}}]
```

</details>

<details>
<summary><strong>미니장바구니 실습/frontend/.next/_events_29188.json</strong> — Next.js CLI 서버 실행 중 기록된 세션 이벤트 로그 파일입니다.</summary>

```json
[{"eventName":"NEXT_CLI_SESSION_STOPPED","payload":{"nextVersion":"16.3.1","nodeVersion":"v24.19.0","cliCommand":"dev","durationMilliseconds":1574,"turboFlag":true,"pagesDir":false,"appDir":true,"isRspack":false}}]
```

</details>

<details>
<summary><strong>미니장바구니 실습/frontend/.next/types/cache-life.d.ts</strong> — Next.js 캐시 정책(cacheLife)에 사용하는 TypeScript 타입 선언 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/types/root-params.d.ts</strong> — 루트 파라미팅 타입을 지정하기 위해 자동으로 정적 생성된 선언 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/types/routes.d.ts</strong> — Next.js 앱 내 라우트 경로 및 매개변수 타입을 관리하는 타입 선언 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/types/validator.ts</strong> — 페이지 컴포넌팅 타입의 적합성을 자동으로 검증하는 스크립트 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/static/i4PQf1wtzm-edUKqk3aot/_buildManifest.js</strong> — 클라이언트 사이드 자원 정적 로딩 매핑을 위한 빌드 스크립트 파일입니다.</summary>
...
<details>
<summary><strong>미니장바구니 실습/frontend/.next/static/i4PQf1wtzm-edUKqk3aot/_clientMiddlewareManifest.js</strong> — 클라이언트 미들웨어 매처 빌드 매니페스트 스크립트입니다.</summary>
...
- [eslint.config.mjs](./code/1787039281505-170675036.mjs)
- [next-env.d.ts](./code/1787039281506-35288934.ts)
- [next.config.ts](./code/1787039281506-629487933.ts)
- [package.json](./code/1787039281508-530269526.json)
- [postcss.config.mjs](./code/1787039281508-106031923.mjs)
- [tsconfig.json](./code/1787039281509-325950839.json)
- [globals.css](./code/1787039281510-97889461.css)
- [layout.tsx](./code/1787039281511-49169216.tsx)
- [page.tsx](./code/1787039281511-172853020.tsx)
- [app-path-routes-manifest.json](./code/1787039281512-183490879.json)
- [build-manifest.json](./code/1787039281513-657282670.json)
- [export-marker.json](./code/1787039281514-901175544.json)
- [fallback-build-manifest.json](./code/1787039281515-905945499.json)
- [images-manifest.json](./code/1787039281516-29931429.json)
- [next-minimal-server.js.nft.json](./code/1787039281517-875558615.json)
- [next-server.js.nft.json](./code/1787039281518-593098335.json)
- [package.json](./code/1787039281518-871018012.json)
- [prerender-manifest.json](./code/1787039281519-680188525.json)
- [required-server-files.js](./code/1787039281520-339681524.js)
- [required-server-files.json](./code/1787039281521-403464034.json)
- [routes-manifest.json](./code/1787039281522-898655634.json)
- [_events_14216.json](./code/1787039281523-123894765.json)
- [_events_19936.json](./code/1787039281523-437047075.json)
- [_events_22000.json](./code/1787039281524-318958060.json)
- [_events_25732.json](./code/1787039281525-397330327.json)
- [_events_29188.json](./code/1787039281526-639664125.json)
- [cache-life.d.ts](./code/1787039281527-80192903.ts)
- [root-params.d.ts](./code/1787039281528-534628063.ts)
- [routes.d.ts](./code/1787039281529-848584803.ts)
- [validator.ts](./code/1787039281529-536202412.ts)
- [_buildManifest.js](./code/1787039281530-914360610.js)
- [_clientMiddlewareManifest.js](./code/1787039281531-154494794.js)

## 이미지

![file.svg](./images/1787039281480-959745552.svg) (대표)
![globe.svg](./images/1787039281481-947318112.svg)
![next.svg](./images/1787039281481-587140866.svg)
![vercel.svg](./images/1787039281485-344467072.svg)
![window.svg](./images/1787039281486-299639286.svg)
![favicon.ico](./images/1787039281487-226711056.ico)
![favicon.2vob68tjqpejf.ico](./images/1787039281487-748872255.ico)

## 실행 결과

![screenshot-root-1787039251236.png](./images/1787039281532-498527371.png)

## 첨부파일

- [README.md](./attachments/1787039281488-956989103.md)
- [.env.local](./attachments/1787039281489-842208816.local)
- [.gitignore](./attachments/1787039281490-364276826)
- [AGENTS.md](./attachments/1787039281491-427056420.md)
- [CLAUDE.md](./attachments/1787039281491-494601525.md)
- [devserver.log](./attachments/1787039281492-26078592.log)
- [README.md](./attachments/1787039281493-172182957.md)
- [BUILD_ID](./attachments/1787039281494-789685712)
- [trace](./attachments/1787039281494-21134125)
- [trace-build](./attachments/1787039281495-665451574)
- [4fa387ec64143e14-s.2tuy5pz7dlieh.woff2](./attachments/1787039281496-936625034.woff2)
- [53b9e256198e5412-s.390ncx5urfkfu.woff2](./attachments/1787039281497-898452239.woff2)
- [5ce348bf30bf5439-s.31988l_ccedte.woff2](./attachments/1787039281497-624272059.woff2)
- [6306c77e7c8268e4-s.2dbetqa9o8jxf.woff2](./attachments/1787039281498-913334198.woff2)
- [7178b3e590c64307-s.21jp631_3pja2.woff2](./attachments/1787039281499-676718099.woff2)
- [797e433ab948586e-s.p.0r6juujl39pe6.woff2](./attachments/1787039281500-557610129.woff2)
- [7d817b4c03b0c5f1-s.1uyisp29ctx0d.woff2](./attachments/1787039281501-705286454.woff2)
- [8a480f0b521d4e75-s.1qq4vpdcun5oj.woff2](./attachments/1787039281502-528121321.woff2)
- [bbc41e54d2fcbd21-s.1rgnod-3esatf.woff2](./attachments/1787039281503-947847575.woff2)
- [caa3a2e1cccd8315-s.p.0wgildi0cnwt9.woff2](./attachments/1787039281504-973537749.woff2)
- [fef07dbb0973bf53-s.3p2_lha1f2xer.woff2](./attachments/1787039281504-165771500.woff2)

## 배운 점

Next.js(React) 클라이언트에서 FastAPI 백엔드로 RESTful API 요청(GET, POST, PATCH, DELETE)을 처리하고 데이터를 비동기적으로 동기화하는 방법을 배웠습니다.

## 어려웠던 점

장바구니 내 상품의 수량 조절(PATCH) 및 중복 상품 추가 시 장바구니 목록 내 상태를 실시간으로 갱신하는 비동기 데이터 관리와 백엔드 상태 연동 로직 작성이 까다로웠습니다.

---
_Study Archive에서 자동 생성됨 · 마지막 수정: 2026-08-18T07:48:01.533Z_