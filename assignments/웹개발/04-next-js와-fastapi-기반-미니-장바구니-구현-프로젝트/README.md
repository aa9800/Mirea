...
**미니장바구니 실습/frontend/eslint.config.mjs**

Next.js 및 TypeScript 프로젝트의 코드 스타일과 무시할 파일 경로를 정의하는 ESLint 설정 파일입니다.
...
**미니장바구니 실습/frontend/next-env.d.ts**

Next.js의 TypeScript 지원을 위해 자동 생성된 환경 타입 선언 파일입니다.
...
**미니장바구니 실습/frontend/next.config.ts**

Next.js 프레임워크 전반의 빌드 옵션 및 환경 구성을 설정하는 파일입니다.
...
**미니장바구니 실습/frontend/package.json**

프론트엔드 앱의 프로젝트 메타데이터, 스크립트 명령어, 패키지 의존성(Next.js, React, Tailwind CSS 등)을 관리하는 파일입니다.
...
**미니장바구니 실습/frontend/postcss.config.mjs**

Tailwind CSS 컴파일을 위한 PostCSS 플러그인 설정 파일입니다.
...
**미니장바구니 실습/frontend/tsconfig.json**

TypeScript 컴파일 옵션, 모듈 해석 규칙 및 경로 별칭 설정이 담긴 파일입니다.
...
**미니장바구니 실습/frontend/app/globals.css**

Tailwind CSS 모듈을 불러오고 기본 라이트/다크 테마 및 스타일 변수를 설정한 CSS 파일입니다.
...
**미니장바구니 실습/frontend/app/layout.tsx**

애플리케이션 최상위 레이아웃 구성 요소로 폰트 및 글로벌 HTML 구조를 정의하는 파일입니다.
...
**미니장바구니 실습/frontend/app/page.tsx**

상품 목록 및 장바구니 조작(추가, 수량 변경, 삭제)을 위한 백엔드 API 연동과 메인 UI를 담고 있는 컴포넌트 파일입니다.
...
**미니장바구니 실습/frontend/.next/app-path-routes-manifest.json**

Next.js App Router 경로와 파일 간의 매핑을 기록한 빌드 생성 결과 파일입니다.
...
**미니장바구니 실습/frontend/.next/build-manifest.json**

빌드 단계에서 생성된 청크 파일 및 리소스 스크립트 매핑 정보를 가지고 있는 파일입니다.
...
**미니장바구니 실습/frontend/.next/export-marker.json**

Next.js 내보내기(Export) 메타데이터 설정 정보를 포함하는 파일입니다.
...
**미니장바구니 실습/frontend/.next/fallback-build-manifest.json**

대체(Fallback) 렌더링에 필요한 빌드 매니페스트 파일입니다.
...
**미니장바구니 실습/frontend/.next/images-manifest.json**

Next.js Image 컴포넌트의 허용 규격, 로더 및 이미지 최적화 설정을 담은 메니페스트입니다.
...
**미니장바구니 실습/frontend/.next/next-minimal-server.js.nft.json**

Next.js 경량 서버 동작에 필요한 의존성 파일 트레이스 결과가 담긴 JSON입니다.
...
**미니장바구니 실습/frontend/.next/next-server.js.nft.json**

Next.js 서버 구동에 필요한 전체 파일 추적 목록을 정의한 파일입니다.
...
**미니장바구니 실습/frontend/.next/package.json**

.next 내부 모듈 시스템 규격을 CommonJS로 지정하는 매니페스트 파일입니다.

```json
{"type": "commonjs"}
```

**미니장바구니 실습/frontend/.next/prerender-manifest.json**

정적 생성(SSG) 및 사전 렌더링 라우트 정보를 담고 있는 빌드 메타데이터입니다.
...
**미니장바구니 실습/frontend/.next/required-server-files.js**

Next.js 서버 실행에 필요한 설정 객체를 저장한 스크립트 파일입니다.
...
**미니장바구니 실습/frontend/.next/required-server-files.json**

Next.js 서버 동작 필수 환경 구성 값을 담은 JSON 파일입니다.
...
**미니장바구니 실습/frontend/.next/routes-manifest.json**

애플리케이션의 라우팅 구조, 리다이렉트 및 헤더 관련 빌드 설정이 기재된 파일입니다.
...
**미니장바구니 실습/frontend/.next/_events_14216.json**

Next.js CLI 서버 실행 중 기록된 세션 이벤트 로그 파일입니다.
...
**미니장바구니 실습/frontend/.next/_events_19936.json**
...
**미니장바구니 실습/frontend/.next/_events_22000.json**
...
**미니장바구니 실습/frontend/.next/_events_25732.json**
...
**미니장바구니 실습/frontend/.next/_events_29188.json**
...
**미니장바구니 실습/frontend/.next/types/cache-life.d.ts**

Next.js 캐시 정책(cacheLife)에 사용하는 TypeScript 타입 선언 파일입니다.
...
**미니장바구니 실습/frontend/.next/types/root-params.d.ts**

루트 파라미팅 타입을 지정하기 위해 자동으로 정적 생성된 선언 파일입니다.
...
**미니장바구니 실습/frontend/.next/types/routes.d.ts**

Next.js 앱 내 라우트 경로 및 매개변수 타입을 관리하는 타입 선언 파일입니다.
...
**미니장바구니 실습/frontend/.next/types/validator.ts**

페이지 컴포넌팅 타입의 적합성을 자동으로 검증하는 스크립트 파일입니다.
...
**미니장바구니 실습/frontend/.next/static/i4PQf1wtzm-edUKqk3aot/_buildManifest.js**

클라이언트 사이드 자원 정적 로딩 매핑을 위한 빌드 스크립트 파일입니다.
...
**미니장바구니 실습/frontend/.next/static/i4PQf1wtzm-edUKqk3aot/_clientMiddlewareManifest.js**

클라이언트 미들웨어 매처 빌드 매니페스트 스크립트입니다.
