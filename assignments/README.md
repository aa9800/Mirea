...
총 6개 · 과목 4개 · Study Archive에서 자동 생성됨
...
- **[Open-Meteo API 기반 날씨 및 대기질 조회 및 외출 판정 프로그램](./python/03-open-meteo-api-기반-날씨-및-대기질-조회-및-외출-판정-프로그램/)** · 2026-08-19 — `python` `requests` `api` `open-meteo` `multithreading`
