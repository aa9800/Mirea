...
- **[Supabase와 바닐라 JS 기반 문장 도서관 대출 및 운영 시스템](./웹개발-데이터베이스/01-supabase와-바닐라-js-기반-문장-도서관-대출-및-운영-시스템/)** · 2026-08-19 — `supabase` `postgresql` `javascript` `html/css` `rls`

## 풀스택 웹 개발 (1)

- **[Next.js 및 FastAPI 기반 미니 장바구니 애플리케이션](./풀스택-웹-개발/01-next-js-및-fastapi-기반-미니-장바구니-애플리케이션/)** · 2026-08-19 — `next.js` `fastapi` `sqlite` `react` `python` `typescript`
...
- **[파이썬 기초 문법과 제어문 및 리스트 활용 실습](./python/03-파이썬-기초-문법과-제어문-및-리스트-활용-실습/)** · 2026-08-19 — `python` `제어문` `반복문` `리스트` `기초실습`
